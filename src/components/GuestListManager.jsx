...
const mobileFieldLabelClass =
  'flex flex-col gap-1 text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-sage-dark/70'
        ...
        <div className="md:hidden">
          ...
          <div className="space-y-4 p-4">
            {visibleHouseholds.map((household) => {
              ...
              const guestCount = household.guests.length + (household.plusOneAllowed && !hasPlusOneGuest ? 1 : 0)
              return (
                <div key={household.id} className="rounded-2xl border border-sage/25 bg-white p-4 shadow-sm">
                  ...
                  <details className="mt-3 rounded-xl border border-sage/20 bg-sage/5 px-3 py-2">
                  ...
                  <button
                    type="button"
                    onClick={() => toggleHouseholdExpanded(household.id)}
                    className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-sage/30 bg-white px-3 py-2 text-sm font-semibold text-sage-dark transition hover:border-sage"
                  >
                  ...
                  {isExpanded && (
                    <div className="mt-3 space-y-3">
                      {household.guests.map((guest) => (
                        <div
                          key={`${household.id}-${guest.id}`}
                          className="rounded-xl border border-sage/20 bg-sage/10 p-3"
                          style={{ animation: 'guestRowFadeIn 200ms ease-out' }}
                        >
                          <div className="flex items-center gap-2">
                            <input
